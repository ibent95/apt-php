<?php
    ...
    $kurirAll = getKurirLimitAll($page, class_static_value::$record_count);

    $pagination = new Zebra_Pagination();
    $pagination->records(mysqli_num_rows(getKurirAll()));
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <p class="pull-left">
                            <a class="btn btn-primary" href="?content=data_kurir_form&action=tambah">
                                Tambah Data
                            </a>
                        </p>
                    </div>
                ...
                <div class="table-responsive">
                    <table class="table table-hover table-striped table-bordered">
                        ...
                        <tbody id="data_list">
                            <?php if (mysqli_num_rows($kurirAll) == 0): ?>
                                <tr>
                                    <td colspan="6">
                                        <center>
                                            Tidak ada data..!
                            ...
                            <?php endif ?>
                            <?php if (mysqli_num_rows($kurirAll) >= 1): ?>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a
                                                ...
                                                href="?content=data_kurir_rincian&action=lihat&id=<?php echo $data['id_kurir']; ?>"
                                                id="detail_kurir"
                                            >
                                            ...
                                            <a
                                                ...
                                                href="?content=data_kurir_form&action=ubah&id=<?php echo $data['id_kurir']; ?>"
                                            >
                                            ...
                                            <a
                                                ...
                                                href="?content=data_kurir_proses&proses=remove&id=<?php echo $data['id_kurir']; ?>"

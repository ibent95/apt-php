<?php 
    ...
    if ($action == 'ubah') {
        $pengguna = mysqli_fetch_assoc(getPenggunaById($id));
    }
?>
        ...
        <div class="page-header float-right">
            <div class="page-title">
                <ol class="breadcrumb text-right">
                    ...
                    <li class=""><a href="?content=data_pengguna">Lainnya</a></li>
                ...
                <div class="card-body">
                    ...
                    >
                        ...
                        <?php if (!empty($pengguna['foto'])) : ?>
                            <div class="form-group">
                                <div class="">
                                    <img class="img-thumbnail" width='90dp' src='<?php echo searchFile($pengguna["foto"], "img", "short"); ?>' id="image_gallery" />
                                </div>
                            </div>
                        <?php endif ?>
                        ...
                        <div class="form-group row">
                            <div class="col-md-4">
                                <label for="jenis_akun" class="control-label">Status Akun</label>
                                <select class="form-control input-rounded input-focus" name="status_akun" id="status_akun">
                                    ...
                                    <option 
                                        value="non-aktif"
                                        <?php if ($action == 'ubah' && $pengguna['status_akun'] == 'non_aktif'): ?>
                                            selected
                                        <?php endif ?>
                                    >
                                        Non Aktif
